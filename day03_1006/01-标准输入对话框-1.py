...
class Window(QWidget):
    ...
    def initUI(self):
        ...
        self.bt1 = QLabel('姓名', self)
        self.bt1.move(20, 20)

        self.bt2 = QLabel('年龄', self)
        self.bt2.move(20, 80)
        ...
        for i in [self.bt1, self.bt2, self.bt3, self.bt4, self.bt5]:
            i.clicked.connect(self.showDialog)
